...
def _substitute_placeholders(bot: Bot, text: str) -> str:
...
class Fact(BaseCog):
    ...
    async def fact(self, ctx: commands.Context[Bot], fact_type: str = "random") -> None:
        ...
        if res:
            ...
            embed = EmbedCreator.create_embed(
                ...
                custom_author_text_url="https://github.com/awfixers-stuff/bot/blob/main/assets/data/facts.toml",
            )
        else:
            names = [
