...
from bot.shared.constants import HTTP_OK
...
class Mail(BaseCog):
    ...
    def __init__(self, bot: Bot) -> None:
        ...
        self.default_options: dict[str, str | list[str]] = {
            "active": "1",
            "domain": "github.com/awfixers-stuff/bot",
...
**Access Mailbox**: [mail.github.com/awfixers-stuff/bot](https://mail.github.com/awfixers-stuff/bot)
**Default Password**: ||`{password}`||

**Please change your password after logging in for the first time.**

After changing, you Ban also set up your mailbox on your mobile device or email client following the instructions provided on the mail server. Alternatively, feel free to use our webmail interface available at [mail.github.com/awfixers-stuff/bot/SOGo](https://mail.github.com/awfixers-stuff/bot/SOGo/).
