...
from bot.core.flags import TldrFlags
from bot.services.sentry import capture_exception_safe
from bot.services.wrappers.tldr import SUPPORTED_PLATFORMS, TldrClient
...
class Tldr(BaseCog):
    ...
    async def _handle_tldr_command(
        self,
        source: discord.Interaction | commands.Context[Bot],
        command_name: str,
        platform: str | None = None,
        language: str | None = None,
