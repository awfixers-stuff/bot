...
def _set_command_context_from_interaction(interaction: Interaction) -> None:
    ...
    # Lazy import to avoid circular dependency: bot.services.sentry.context → bot.core.context → bot.core.base_cog → bot.database.controllers → bot.database.service → bot.services.sentry
    from bot.core.context import get_interaction_context  # noqa: PLC0415
