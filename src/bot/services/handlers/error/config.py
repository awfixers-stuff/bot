...
ERROR_CONFIG_MAP: dict[type[Exception], ErrorHandlerConfig] = {
    ...
    # === Custom Errors ===
    BotPermissionLevelError: ErrorHandlerConfig(
        message_format="You need permission level `{error.permission}`.",
        send_to_sentry=False,
    ),
    BotAppCommandPermissionLevelError: ErrorHandlerConfig(
        message_format="You need permission level `{error.permission}`.",
        send_to_sentry=False,
    ),
    BotPermissionDeniedError: ErrorHandlerConfig(
        message_format="{message}",
        detail_extractor=extract_permission_denied_details,
        send_to_sentry=False,
    ),
    BotMissingCodeError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
        send_to_sentry=False,
    ),
    BotInvalidCodeFormatError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
        send_to_sentry=False,
    ),
    BotUnsupportedLanguageError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
        send_to_sentry=False,
    ),
    BotCompilationError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
    ),
    BotCodeExecutionError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
    ),
    # === HTTPX Errors ===
