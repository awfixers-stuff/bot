...
from bot.core.task_monitor import TaskMonitor
from bot.database.controllers import DatabaseCoordinator
from bot.database.models.enums import CaseType
from bot.database.service import DatabaseService
from bot.services.emoji_manager import EmojiManager
...
from bot.shared.exceptions import BotDatabaseConnectionError
from bot.shared.version import get_version
from bot.ui.banner import create_banner
...
class Bot(commands.Bot):
    ...
    async def setup_hook(self) -> None:
        ...
        from bot.core.http_config import configure_discord_http_client  # noqa: PLC0415
