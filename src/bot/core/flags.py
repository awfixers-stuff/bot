...
from bot.core.converters import (
    CaseTypeConverter,
...
from bot.shared.constants import DEFAULT_REASON
...
class BotFlagConverter(commands.FlagConverter):
...
class BanFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class TempBanFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class UnbanFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
    """Flags for unban commands."""


class KickFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class WarnFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class TimeoutFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class JailFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class UnjailFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class PollBanFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class TldrFlags(BotFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
