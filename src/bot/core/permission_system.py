...
from bot.cache.backend import get_cache_backend
...
from bot.shared.exceptions import BotDatabaseError
...
class PermissionSystem:
    ...
    async def initialize_guild(self, guild_id: int) -> None:
        ...
        except (BotDatabaseError, sqlalchemy.exc.SQLAlchemyError) as e:
            logger.error(
