...
from bot.core.permission_system import PermissionSystem, get_permission_system
    ...
    *,
    ...
    def decorator(func: F) -> F:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if getattr(wrapper, "__bot_perm_check_in_phase__", False):
        ...
        wrapper.__bot_perm_allow_unconfigured__ = allow_unconfigured  # type: ignore[attr-defined]
        wrapper.__bot_perm_allow_self_use_for_param__ = allow_self_use_for_param  # type: ignore[attr-defined]
...
async def command_permission_check(ctx: commands.Context[Any]) -> bool:
    ...
    allow_unconfigured = getattr(callback, "__bot_perm_allow_unconfigured__", False)
    await _check_permissions(
        ctx,
...
async def _check_permissions(
    ...
    if cmd_perm is None:
        if not allow_unconfigured:
            ...
            raise BotPermissionDeniedError(
                required_rank=0,
                user_rank=0,
