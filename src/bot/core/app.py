...
from bot.help import BotHelp
from bot.services.sentry import SentryManager, capture_exception_safe
from bot.shared.config import CONFIG

if TYPE_CHECKING:
    from bot.core.bot import Bot

__all__ = ["BotApp", "get_prefix"]
...
class BotApp:
    ...
    async def start(self) -> int:
        ...
        # This is a fallback - normally configured in scripts/bot/start.py
        # CRITICAL: Must be before SentryManager.setup() because Sentry uses logger
        from bot.core.logging import configure_logging  # noqa: PLC0415
    ...
    def _create_bot_instance(self, owner_ids: set[int]) -> "Bot":
        """Create and configure the Bot bot instance."""
        from bot.core.bot import Bot  # noqa: PLC0415
