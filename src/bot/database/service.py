...
class DatabaseService:
    ...
    async def test_connection(self) -> None:
        ...
        try:
            ...
            # Lazy import to avoid circular dependency: bot.database.service → bot.services.sentry → bot.core.context → bot.database.controllers → bot.database.service
            from bot.services.sentry import capture_database_error  # noqa: PLC0415
