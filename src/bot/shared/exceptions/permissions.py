...
class BotPermissionLevelError(BotPermissionError):
...
class BotAppCommandPermissionLevelError(BotPermissionError):
...
class BotPermissionDeniedError(
    BotPermissionError,
    ...
    def __init__(
        ...
        BotPermissionError.__init__(self, message)
