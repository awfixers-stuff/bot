...
EMBED_ICONS: Final[dict[str, str]] = {
    ...
    "ACTIVE_CASE": "https://github.com/awfixers-stuff/bot/blob/main/assets/embeds/active_case.avif?raw=true",
    "INACTIVE_CASE": "https://github.com/awfixers-stuff/bot/blob/main/assets/embeds/inactive_case.avif?raw=true",
    "ADD": "https://github.com/awfixers-stuff/bot/blob/main/assets/emojis/added.avif?raw=true",
    "REMOVE": "https://github.com/awfixers-stuff/bot/blob/main/assets/emojis/removed.avif?raw=true",
    "BAN": "https://github.com/awfixers-stuff/bot/blob/main/assets/emojis/ban.avif?raw=true",
    "JAIL": "https://github.com/awfixers-stuff/bot/blob/main/assets/emojis/jail.avif?raw=true",
    "KICK": "https://github.com/awfixers-stuff/bot/blob/main/assets/emojis/kick.avif?raw=true",
    "TIMEOUT": "https://github.com/awfixers-stuff/bot/blob/main/assets/emojis/timeout.avif?raw=true",
    "WARN": "https://github.com/awfixers-stuff/bot/blob/main/assets/emojis/warn.avif?raw=true",
}

# Help banner URL (cached via GitHub CDN)
HELP_BANNER_URL: Final[str] = (
    "https://github.com/awfixers-stuff/bot/blob/main/assets/branding/help_banner.png?raw=true"
)
