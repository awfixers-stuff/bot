...
When you run `/report`, Bot will open a pop-up window (modal) with several fields for you to fill out:
...
Once you submit the modal, Bot will:
...
!!! info "Permission System"
    Server administrators can restrict who can use the report command via Bot's dynamic permission system. Configure via `/config commands`.
...
- Contact a server administrator to ensure the moderation log channel is set correctly in Bot's configuration
