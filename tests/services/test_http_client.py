...
class TestHTTPClient:
    ...
    @pytest.mark.asyncio
    async def test_get_client_creates_client(self, client: HTTPClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_client_reuses_client(self, client: HTTPClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_close_client(self, client: HTTPClient) -> None:
...
class TestGlobalHTTPClient:
    ...
    @pytest.mark.asyncio
    async def test_global_client_get(self, httpx_mock: HTTPXMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_global_client_post(self, httpx_mock: HTTPXMock) -> None:
...
class TestHTTPClientIntegration:
    ...
    @pytest.mark.asyncio
    async def test_avatar_module_integration(self, httpx_mock: HTTPXMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_wiki_module_integration(self, httpx_mock: HTTPXMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_godbolt_service_integration(self, httpx_mock: HTTPXMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_wandbox_service_integration(self, httpx_mock: HTTPXMock) -> None:
...
class TestHTTPClientErrorScenarios:
    ...
    @pytest.mark.asyncio
    async def test_http_status_error(self, httpx_mock: HTTPXMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_custom_timeout_parameter(self, httpx_mock: HTTPXMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_custom_headers_parameter(self, httpx_mock: HTTPXMock) -> None:
