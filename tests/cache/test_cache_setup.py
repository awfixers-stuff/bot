...
async def test_setup_when_valkey_url_empty_sets_cache_service_none(
    ...
    with patch("bot.core.setup.cache_setup.CONFIG") as mock_config:
...
async def test_setup_when_connect_raises_sets_cache_service_none(
    ...
    with patch("bot.core.setup.cache_setup.CONFIG") as mock_config:
        ...
        with patch("bot.core.setup.cache_setup.CacheService") as mock_cls:
            instance = MagicMock()
    ...
    try:
        with patch("bot.core.setup.cache_setup.CONFIG") as mock_config:
            ...
            with patch("bot.core.setup.cache_setup.CacheService") as mock_cls:
                ...
                with patch(
                    "bot.core.setup.cache_setup.get_cache_backend",
