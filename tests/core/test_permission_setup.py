...
from bot.core.setup.permission_setup import PermissionSetupService
...
async def test_setup_initializes_db_coordinator_with_cache_backend() -> None:
    ...
    with (
        patch(
            "bot.core.setup.permission_setup.get_cache_backend",
            return_value=mock_backend,
        ),
        patch(
            "bot.core.setup.permission_setup.DatabaseCoordinator",
            return_value=mock_coordinator,
        ) as mock_coord_cls,
        patch(
            "bot.core.setup.permission_setup.init_permission_system",
        ) as mock_init,
    ):
